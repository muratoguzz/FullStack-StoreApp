...
namespace Repositories
{
    public class OrderRepository : RepositoryBase<Order>, IOrderRepository
    {
        ...
        {
            _context.AttachRange(order.Lines.Select(l => l.Product));//OrderLine de birden fazla ürün olabilir, Lines koleksiyonundaki her bir product nesnesini izlemek için yazdık
            if (order.OrderId == 0)
            {
